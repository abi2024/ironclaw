...
pub trait Guest {
    /// The Guest (WASM) must export a function called 'run'.
    /// It takes a string (input) and returns a string (output).
    fn run(input: _rt::String) -> _rt::String;
}
#[doc(hidden)]
macro_rules! __export_world_tool_cabi {
...
#[doc(hidden)]
pub(crate) use __export_world_tool_cabi;
...
macro_rules! __export_tool_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*:: __export_world_tool_cabi!($ty with_types_in
        $($path_to_types_root)*);
    };
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:ironclaw:tools:tool:encoded world"
)]
#[doc(hidden)]
...
@\x01\x05inputs\0s\x04\0\x03run\x01\0\x04\0\x13ironclaw:tools/tool\x04\0\x0b\x0a\
\x01\0\x04tool\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x07\
